...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <script type="text/javascript">
        ...
        function MsgFadeOut() {
            ...
            //phReproduction
            $('#discl_CAN').css('visibility', 'hidden');
            setTimeout("$('#discl_CAN').css('visibility', 'visible')", 8000);
            setTimeout("$('#discl_CAN').fadeIn(2000,'linear')", 10000);
    ...
    <asp:PlaceHolder ID="phCanForm" runat="server">
        ...
        form. <a class="open-1" style="cursor: pointer;">See more</a><a class="open-2" style="cursor: pointer; display: none;">Hide</a><br />
            ...
            <table id="DCANForm">
                <tr>
                    <td id="column-1">
                        ...
                        Card. You may list up to four people living at the same address on one card. <strong>Each traveller is responsible for his or her own declaration.</strong>
                        </p>
                        <p>
                        ...
                        see Info Source (ref. no. CBSA PPU 018), at a public library or visit <a href="http://infosource.gc.ca"
                            target="_blank"><strong>http://infosource.gc.ca</strong></a>.
                        </p>
                        <h2>Part B - Visitors to Canada</h2>
                        <p>
                        ...
                        <h2>Part C - Residents of Canada</h2>
                        <p>
                        ...
                        <table id="note-1">
                            <tr>
                                <td style="font-weight: bold; text-align: center;">Alcohol and tobacco<br />
                                    exemption table
                                </td>
                            </tr>
                            <tr>
                                <td>1.5 L of wine or 1.14 L of liquor or 24 x 355 ml cans or bottles (8.5 L) of beer
                                or ale. (You must be of legal age in the province of importation.)
                                </td>
                            </tr>
                            <tr>
                                <td>200 cigarettes, 200 tobacco sticks, 50 cigars or cigarillos and 200 grams of manufactured
                    ...
                    <td id="column-3" style="vertical-align: top;">
                        <table id="table-1">
                            <tr>
                                <td colspan="2" class="header">Part A / All travellers (living at the same address)
                                </td>
                            </tr>
                            <tr>
                                <td class="td-1">1
                        ...
                        <table id="table-3">
                            <tr>
                                ...
                                <td style="width: 120px; padding-right: 20px; border-right: 1px solid #000; border-left: 1px solid #000; text-align: right;">
                        ...
                        <table id="table-4">
                            <tr>
                                ...
                                <td style="padding: 5px 0; text-align: right; width: 23px;">Yes
                                </td>
                                <td style="padding: 5px 0; text-align: center; width: 23px;">No
                                </td>
                            </tr>
                            <tr>
                                <td>
                        ...
                        <table id="table-5">
                            <tr>
                                <td colspan="3" class="header">Part B / Visitors to Canada
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 200px;">
                                ...
                                <td style="width: 350px;">Do you or any person listed above exceed the duty-free allowances per person?<br />
                        ...
                        <table id="table-6">
                            <tr>
                                <td colspan="2" class="header">Part C / Residents of Canada
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 550px;">Do you or any person listed above exceed the exemptions per person?<br />
                                    <em>(See instructions on the left.)</em>
                                </td>
                                <td>
                        ...
                        <table id="table-7">
                            <tr>
                                <td colspan="6" class="header">Complete in the same order as Part A
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">Date left Canada
                                <br />
                                    YYYY - MM - DD
                                </td>
                                <td>Value of goods - CAN$<br />
                        ...
                        <table id="table-8">
                            <tr>
                                <td colspan="4" class="header">Part D / Signatures (age 16 and older): I certify that my declaration is true and
                                complete.
                                </td>
                            </tr>
                            <tr>
    ...
    <asp:PlaceHolder ID="phCanFormWrongName1" runat="server" Visible="false"><span class="span50"></span>
