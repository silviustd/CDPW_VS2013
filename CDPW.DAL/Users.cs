...
namespace CDPW.DAL
{
    public class Users
    {
        ...
        public static bool Check_Email(string email, Boolean UseAlternateEmail, ref string uName)
        {
            if (log.IsInfoEnabled) log.Info(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType.Name + "-" + System.Reflection.MethodBase.GetCurrentMethod().Name + " - Enter");
            bool emailExists = false;
            ...
            using (SqlConnection dbConnection = new SqlConnection(DBConnection.ConnectionString))
            {
                ...
                cmd.Parameters.Add("@Action", SqlDbType.TinyInt).Value = 1;
                cmd.Parameters.Add("@UserEmail", SqlDbType.NVarChar, 50).Value = email;
                cmd.Parameters.Add("@UseAlternateEmail", SqlDbType.Bit).Value = UseAlternateEmail;
        ...
        public static bool Check_EmailDuplicate(Int64 UserId, string UserEmail, Boolean UseAlternateEmail)
        {
            if (log.IsInfoEnabled) log.Info(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType.Name + "-" + System.Reflection.MethodBase.GetCurrentMethod().Name + " - Enter");
            ...
            using (SqlConnection dbConnection = new SqlConnection(DBConnection.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("WAppUser_CheckDuplicateEmail", dbConnection);
                cmd.CommandType = CommandType.StoredProcedure;

                // Add parameters to SPROC
                cmd.Parameters.Add("@WAppUserId", SqlDbType.Int).Value = UserId;
                ...
                dbConnection.Open();
                cmd.ExecuteNonQuery();
                emailExists = TextUtils.ReturnBitFromDB2(returnValue.Value);
        ...
        public static void Password_Reset(string Email, Boolean UseAlternateEmail,string Password)
        {
            if (log.IsInfoEnabled) log.Info(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType.Name + "-" + System.Reflection.MethodBase.GetCurrentMethod().Name + " - Enter");
            using (SqlConnection dbConnection = new SqlConnection(DBConnection.ConnectionString))
            {
