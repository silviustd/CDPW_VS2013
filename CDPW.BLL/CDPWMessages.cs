...
namespace CDPW.BLL
{
    public class CDPWMessages
    {
        ...
        //cdpconfirmreg
        public static String ERR_NO_USER_EMAIL = "Sorry, there is no user  with the email address/username provided. In order to access the application, please Sign-Up <a href={0}>here</a> by using <b>I don't have an account</b>.";
